...
let handleClick = (e) => {
    ...
    else if(cpl.contains(e.target) || cpr.contains(e.target)) handleCurtain(e);
...
let handleCurtain = (e, close = false) => {
    ...
    } else if (!target.classList.contains("moveToLeft") && !target.classList.contains("moveToRight")) {
...
let displaySuccessMessage = () => {
    let introDiv = document.getElementById("c-body");
    let successCode = '<h2 class="c-scroll__heading">Amazing!!!</h2><br><p class="c-scroll__paragraph">Many tried... Yet they all failed... But let\'s continue our journey in search of the treasure through another reality!!!</p> '
    + '<h2 class="c-scroll__heading">The daVinci Code</h2><br><p class="c-scroll__paragraph" style="font-family:\'baseFont\';">Congrats on level 1 completion... Our volunteers will contact you with more details soon...<br>Regards from Team daVinci Code</p>';
